...
export default function GPACalculator() {
  ...
  return (
    <section id="gpa-section" className="py-20 bg-slate-50/50 scroll-mt-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-2xl border border-slate-100 p-6 sm:p-8 shadow-sm">
              {/* Labels header */}
              <div className="hidden sm:grid sm:grid-cols-12 gap-4 mb-4 text-xs font-semibold text-slate-400 uppercase tracking-wider px-3">
              ...
              <div className="space-y-4">
                {courses.map((course, index) => (
                  <div key={course.id} className="grid grid-cols-1 sm:grid-cols-12 gap-3 sm:gap-4 items-center bg-slate-50/50 sm:bg-transparent p-4 sm:p-0 rounded-xl sm:rounded-none border sm:border-0 border-slate-100 relative group transition-colors">
                    
                    {/* Index Counter */}
                    <div className="col-span-1 flex items-center justify-center">
                      <span className="w-8 h-8 rounded-full bg-slate-100 text-slate-500 text-sm font-semibold flex items-center justify-center">
                        {index + 1}
                      </span>
                    </div>
                    ...
                    <div className="col-span-5">
                      <label className="block sm:hidden text-xs font-semibold text-slate-400 mb-1">Credits</label>
                      <select
                        value={course.credits}
                        onChange={(e) => handleCourseChange(course.id, 'credits', e.target.value)}
                        className="w-full bg-white border border-slate-200 rounded-xl px-4 py-3 text-slate-700 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-600 transition-all text-sm appearance-none cursor-pointer"
                    ...
                    {/* Grade Selection */}
                    <div className="col-span-5">
                      <label className="block sm:hidden text-xs font-semibold text-slate-400 mb-1">Grade</label>
                      <select
                        value={course.grade}
                    ...
                    <div className="col-span-1 flex items-center justify-end sm:justify-center">
                      <button
                        ...
                        className="p-2 text-slate-400 hover:text-red-500 rounded-lg hover:bg-red-50/50 transition-colors"
            ...
            {result && (
              <div className="bg-gradient-to-r from-indigo-900 to-indigo-850 text-white rounded-3xl p-6 sm:p-8 shadow-xl shadow-indigo-900/10 border border-indigo-800 animate-fadeIn">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
                  ...
                  {/* Big Number GPA */}
                  <div className="text-center md:text-left border-b md:border-b-0 md:border-r border-indigo-800/80 pb-6 md:pb-0 md:pr-6">
                    <span className="text-indigo-300 text-xs font-bold uppercase tracking-widest block mb-1">Your Semester GPA</span>
                  ...
                  <div className="text-center md:text-left md:col-span-2 space-y-3">
                    <div>
                      <span className="text-indigo-300 text-xs font-bold uppercase tracking-widest block mb-2">Performance Class</span>
                    ...
                    <div className="grid grid-cols-3 gap-4 text-xs sm:text-sm text-indigo-200 pt-2">
                      <div>
                        <span className="text-indigo-400 block text-[10px] uppercase font-bold tracking-wider">Total Subjects</span>
                        <span className="font-bold text-white text-base">{courses.filter(c => c.credits && c.grade).length}</span>
                      </div>
                      <div>
                        <span className="text-indigo-400 block text-[10px] uppercase font-bold tracking-wider">Total Credits</span>
                        <span className="font-bold text-white text-base">{result.totalCredits}</span>
                      </div>
                      <div>
                        <span className="text-indigo-400 block text-[10px] uppercase font-bold tracking-wider">Grade Points</span>
            ...
            <div className="bg-white rounded-2xl border border-slate-100 p-6 shadow-sm">
              ...
              <div className="flex flex-wrap gap-2.5 justify-between mb-4">
                <div className="flex flex-col items-center">
                  <span className="w-9 h-9 rounded-xl bg-emerald-500 text-white font-bold flex items-center justify-center shadow-md shadow-emerald-100">S</span>
                  <span className="text-xs text-slate-500 mt-2 font-medium">10 pts</span>
                </div>
                <div className="flex flex-col items-center">
                  <span className="w-9 h-9 rounded-xl bg-teal-500 text-white font-bold flex items-center justify-center shadow-md shadow-teal-100">A</span>
                  <span className="text-xs text-slate-500 mt-2 font-medium">9 pts</span>
                </div>
                <div className="flex flex-col items-center">
                  <span className="w-9 h-9 rounded-xl bg-blue-500 text-white font-bold flex items-center justify-center shadow-md shadow-blue-100">B</span>
                  <span className="text-xs text-slate-500 mt-2 font-medium">8 pts</span>
                </div>
                <div className="flex flex-col items-center">
                  <span className="w-9 h-9 rounded-xl bg-violet-400 text-white font-bold flex items-center justify-center shadow-md shadow-violet-100">C</span>
                  <span className="text-xs text-slate-500 mt-2 font-medium">7 pts</span>
                </div>
                <div className="flex flex-col items-center">
                  <span className="w-9 h-9 rounded-xl bg-amber-500 text-white font-bold flex items-center justify-center shadow-md shadow-amber-100">D</span>
                  <span className="text-xs text-slate-500 mt-2 font-medium">6 pts</span>
                </div>
                <div className="flex flex-col items-center">
                  <span className="w-9 h-9 rounded-xl bg-orange-500 text-white font-bold flex items-center justify-center shadow-md shadow-orange-100">E</span>
                  <span className="text-xs text-slate-500 mt-2 font-medium">5 pts</span>
                </div>
                <div className="flex flex-col items-center">
                  <span className="w-9 h-9 rounded-xl bg-red-500 text-white font-bold flex items-center justify-center shadow-md shadow-red-100">F</span>
            ...
            <div className="bg-white rounded-2xl border border-slate-100 p-6 shadow-sm">
              ...
              <ol className="space-y-4">
                <li className="flex items-start gap-4">
                  <span className="w-6 h-6 rounded-full bg-indigo-50 text-indigo-600 font-semibold text-xs flex items-center justify-center shrink-0 mt-0.5">
                    1
                  </span>
